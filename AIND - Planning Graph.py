...
# Reference: https://github.com/philferriere/aind-projects/blob/master/planning/my_planning_graph.py
# And thanks to the reviewer who provided me some applicable codes :)
...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            # Create an action ndoe
            a_node = PgNode_a(action)
            # Check status satisfiction
            if a_node.prenodes.issubset(self.s_levels[level]):
                a_nodes.append(a_node)
                # If reachable, make the connection between parent and child node
    ...
    def add_literal_level(self, level):
        ...
        for a_node in self.a_levels[level - 1]:
            # Make the connection between action parent and effect child node
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Check inconsistency of a1 added effect and a2 removed effect
        for effect in node_a1.action.effect_add:
            if effect in node_a2.action.effect_rem:
                return True

        # Check inconsistency of a2 added effect and a1 removed effect
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Check conflict of a1 added effect and a2 negative preconditions
        # Check conflict of a2 added effect and a1 negative preconditions
        for effect in node_a1.action.effect_add:
        ...
        # Check conflict of a1 removed effect and a2 positive preconditions
        # Check conflict of a2 removed effect and a1 positive preconditions
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        '''
        # Rrevision of reviewer's code
        is_negation_mutex = node_s1.symbol == node_s2.symbol and node_s1.is_pos != node_s2.is_pos
        return is_negation_mutex
    ...
    def h_levelsum(self) -> int:
        ...
        level_sum = 0
        # Check the level cost of each node, and its summation
